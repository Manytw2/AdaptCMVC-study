...
class Office31(Dataset):
    ...
    def __init__(self, root='./MyData/office-31', train: bool = True,
                 transform=None, target_transform=None, download: bool = False, views=3) -> None:
        super().__init__()
        self.root = './MyData/office-31'
        self.transform = transform
    ...
    def __getitem__(self, index):
        ...
        self.root = './MyData/office-31'
        view0 = pil_loader(os.path.join(self.root, a.lstrip('/')))
        view1 = pil_loader(os.path.join(self.root, d.lstrip('/')))
        view2 = pil_loader(os.path.join(self.root, w.lstrip('/')))
