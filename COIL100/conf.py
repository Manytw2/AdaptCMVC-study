...
# Learning rate
_C.OPTIM.LR = 0.001              #0.001     #1e-3 #0.0005

# Choices: Adam, SGD
_C.OPTIM.METHOD = 'adamw' #'sgd'
...
###############
_C.VALID_AUGMENTATION = CfgNode()
_C.VALID_AUGMENTATION.CROP_SIZE = 64

_C.Dataset = CfgNode()
_C.Dataset.name = 'office-31' #'coil-20'  EdgeMNISTDataset
_C.Dataset.root = 'MyData' #MyData
_C.Dataset.class_num = 31
_C.Dataset.views = 3

_C.hyperparameters = CfgNode()
_C.hyperparameters.temperature = 0.2
_C.hyperparameters.alpha = 0.1
_C.hyperparameters.contra = 0.5
_C.hyperparameters.consis = 0.5
_C.hyperparameters.N = 2
_C.hyperparameters.sample_num_each_clusters = 10  # 0.01
