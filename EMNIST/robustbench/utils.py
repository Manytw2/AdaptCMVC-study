...
def clean_accuracy_target(source_center: np.array,
        ...
        with torch.no_grad():
            ...
            acc, nmi, ari, _, p, fscore, kmeans_pre, _ = clustering_by_representation(out_reprs, targets, class_num)
            result = {}
            result['consist-acc'] = acc
            result['consist-nmi'] = nmi
            result['consist-ari'] = ari
            ...
            return result, kmeans_pre,r_loss/n_batches, c_loss/n_batches
